...
import Document from '../models/leadDocumentModel.js';
...
export const uploadDocument = async (req, res) => {
  try {
    ...
    const activity = new Activity({
      ...
      leadId : leadId || null,
      metadata: {
        name : populatedDocument.associatedLead.name,
        lastName : populatedDocument.associatedLead.lastName,
        email : populatedDocument.associatedLead.email,
        phone : populatedDocument.associatedLead.phone,
        title: title.trim(),
        originalName: file.originalname,
        fileType: file.mimetype,
        fileSize: file.size,
        filename: file.filename,
        uploadedBy: populatedDocument.uploadedBy.username
      }
    });
...
export const downloadDocument = async (req, res) => {
  try {
    ...
    //   contentId: document._id,
    //   leadId : document.associatedLead || null,
    //   metadata: {
    //     title: document.title,
...
export const updateDocument = async (req, res) => {
  try {
    ...
    //   leadId : updatedDocument.associatedLead._id || null,
    //   metadata: {
...
export const deleteDocument = async (req, res) => {
  try {
    ...
    const activity = new Activity({
      ...
      contentId: document._id,
      leadId : document.associatedLead._id || null,
      metadata: {
        name : document.associatedLead.name + " " + document.associatedLead.lastName,
        email : document.associatedLead.email,
        phone : document.associatedLead.phone,
        title: document.title,
        originalName: document.originalName,
        fileType: document.fileType,
        fileSize: document.fileSize
